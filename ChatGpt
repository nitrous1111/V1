...
if not isfile("Nitrous") then
 ...
 local menu = game:GetObjects("rbxassetid://17585352626")[1] 
 ...
 for _, obj in pairs(menu:GetDescendants()) do
    if obj.Name:lower():find('userlabel') then
        obj.Text = 'active user: <font color="rgb(85, 170, 255)">' .. game.Players.LocalPlayer.Name .. '</font>'
    end
    if obj.Name:lower():find('buildlabel') then
        obj.Text = 'build: <font color="rgb(85, 170, 255)">Public</font>'
    end
 end
 ...
 KeybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(85, 170, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
 ...
 Name.Text = "[<font color=\"rgb(85, 170, 255)\">Keybinds</font>]"
 ...
 Name_2.Text = "Silent Aim: <font color=\"rgb(85, 170, 255)\">[MB1]</font>"
 ...
 local function createWatermark()
    ...
    WatermarkFrame.BorderColor3 = Color3.fromRGB(85, 170, 255)
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'Nitrous<font color="rgb(74, 74, 74)"></font> - uid: <font color="rgb(74, 74, 74)">' .. uid .. '</font> / fps: <font color="rgb(85, 170, 255)">' .. fpsValue .. '</font> / ping: <font color="rgb(85, 170, 255)">' .. ping .. '</font> / time: <font color="rgb(85, 170, 255)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    ...
    Watermark = createWatermark(),
       Colors = {
          libColor = Color3.fromRGB(85, 170, 255),
...
close.TextColor3 = Color3.fromRGB(85, 170, 255)
...
local colors = {
    Color3.fromRGB(85, 170, 255),     -- Text color
}
...
coroutine.wrap(animateText)()
    ...
    for _, obj in pairs(menu:GetDescendants()) do
        if obj.Name:lower():find('name_esp') then
           obj.Text = '<font color="rgb(85, 170, 255)">' .. game.Players.LocalPlayer.Name .. '</font>'
        end
    end
    ...
    library:Create('UIListLayout', {Padding = UDim.new(0, 4); FillDirection = Enum.FillDirection.Vertical; SortOrder = Enum.SortOrder.LayoutOrder; Parent = library.NotificationArea})
        ...
        function library:Notify(Text, Time)
            ...
            local NotifyOuter = library:Create('Frame', {BorderColor3 = Color3.new(85, 170, 255); Position = UDim2.new(0, 100, 0, 10); Size = UDim2.new(0, 0, 0, YSize); ClipsDescendants = true; Transparency = 0; ZIndex = 100; Parent = library.NotificationArea})
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        local imageTweenStart = TweenService:Create(v, tweenInfo, {ImageColor3 = Color3.fromRGB(85, 170, 255)})
                        local textTweenStart = TweenService:Create(v.text, tweenInfo, {TextColor3 = Color3.fromRGB(85, 170, 255)})
                        ...
                        function group:addToggle(args)
                            ...
                            function toggle:addKeybind(args)
                                    ...
                                    if key.Name == "Unknown" or key.Name == "Unknown" then
                                        ...
                                        if args.gui then
                                            ...
                                            if args.type == "hold" then
                                                Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(85, 170, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                            else
                                                if not Toggle then
                                                    Toggle = true
                                                    Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(85, 170, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                    ...
                                                    Toggle = false
                                                    Name.Text = "<font color=\"rgb(125, 125, 125)\">" ..args.text.. ": /font>".." <font color=\"rgb(85, 170, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                end
                                            end
                                        end
                                    end
                                ...
                                if args.gui then
                                    Name.Visible = true
                                    Name.Text = args.text..": <font color=\"rgb(85, 170, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                end
